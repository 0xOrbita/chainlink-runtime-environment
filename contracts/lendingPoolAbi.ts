export const LENDING_POOL_ABI = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_lendingPoolRouter", type: "address" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_orbitaEmitter", type: "address" },
    ],
    name: "setOrbitaEmitter",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      { internalType: "address", name: "_orbitaWorldID", type: "address" },
    ],
    name: "setOrbitaWorldID",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "_proxyDeployer", type: "address" },
    ],
